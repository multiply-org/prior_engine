...
The climatological priors are based on ESA CCI Soil Moisture product [GRUBER2019]_. The global climatology was calculated once and comes with the prior engine package.
